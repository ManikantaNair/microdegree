            ...
            {studentData.map((sd)=> (
                <>
                 ...
                 <div className="my-6 mx-3 flex flex-col shadow-xl rounded-xl border border-white-400">
                     ...
                     <Image src={sd.image} alt="image" width={180} height={180} className="rounded"/>
                     </div>
                     <hr />
                     <div className="py-6 px-2 text-center bg-white">
                  <h2 className ="text-blue-700 font-semibold pt-4">{sd.name}</h2>
                ...
                {studentData.map((sd)=> (
                    <>
                     ...
                     <div className="my-6 mx-2 flex flex-col shadow-xl rounded-xl border border-white-400">
                         ...
                         <Image src={sd.image} alt="image" width={200} height={180} className="rounded"/>
                         </div>
                         <hr />
                         <div className="py-6 px-2 text-center bg-white">
                      <h2 className ="text-blue-700 font-semibold pt-4">{sd.name}</h2>
